...
public class JTServerSecure extends JTServer implements SocketSecureIntf {
	protected final JTSocketSecure secure;

	public JTServerSecure(int port, String key) throws NoSuchProviderException{
		super(port);
	...
	public JTServerSecure(String key) throws NoSuchProviderException{
		super();
		try{
			secure = new JTSocketSecure(key);
		}
